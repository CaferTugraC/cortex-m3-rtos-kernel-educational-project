...
/* * Not: Aşağıdakiler High-Density (F103xE) cihazlarda vardır. 
 * C8T6 (Medium Density) fiziksel olarak bu donanımlara sahip değildir 
 * ama tabloyu doldurmakta sakınca yoktur.
 */
...
void Reset_Handler(void)
{
    ...
    uint8_t *pScr = (uint8_t*)&_la_data; // flash
